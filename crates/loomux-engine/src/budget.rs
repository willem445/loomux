...
mod tests {
    ...
    /// Hold `lock` until the returned sender drops, returning once the hold is
    /// REAL. Same handshake as `lockwatch`'s: a test that spawns a holder and
    /// hopes is measuring the scheduler.
