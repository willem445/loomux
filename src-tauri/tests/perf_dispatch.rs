...
#[test]
#[ignore = "SCRATCH ONLY (#1608): red until the two commands land; ignored here so cargo reaches tests/views.rs, which sorts after this target. Never merge this branch."]
