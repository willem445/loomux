...
//!
//!   - `generate_handler_matches_app_commands` / `app_commands_len_is_152`:
...
//!   - `main_has_all_152_and_zero_permission_denies_dangerous_spread`: builds
...
//!     invokes all 152 commands against the `main` window label, and invokes
...
//! `main_has_all_152_and_zero_permission_denies_dangerous_spread` fail with
