...
function tooltip(c: WipCap, fill: WipFill): string {
  ...
  const enforced = c.enforce
    ...
    : ` orrerix warns the orchestrator about this; it does not refuse anything (set board.enforce: true in this repo's workflow file to make it a refusal for agents).`;
